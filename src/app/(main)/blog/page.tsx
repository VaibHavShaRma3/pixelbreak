...
const gradientColors = [
  "from-neon-cyan/30 to-neon-pink/20",
  "from-neon-pink/30 to-neon-purple/20",
  "from-neon-green/30 to-neon-cyan/20",
];
                ...
                <Link href={`/blog/${post.slug}`}>
                  ...
                  >
                    ...
                    {post.coverImage ? (
                      ...
                      <div
                        className={`-mx-6 -mt-6 mb-4 flex h-48 items-center justify-center rounded-t-xl bg-gradient-to-br ${gradientColors[i % gradientColors.length]}`}
                      >
                    ...
                    {/* Title */}
                    <h2 className="font-[family-name:var(--font-pixel)] text-lg text-neon-cyan">
                      {post.title}
                    </h2>
